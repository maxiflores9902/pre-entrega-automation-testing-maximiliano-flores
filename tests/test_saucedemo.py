...
def test_agregar_producto_al_carrito(driver):
    ...
    primer_producto_btn = esperar_elemento(driver, By.XPATH, "(//button[contains(text(),'Add to cart')])[1]")
    primer_producto_btn.click()

    contador = esperar_elemento(driver, By.CLASS_NAME, "shopping_cart_badge").text
    assert contador == "1"

    esperar_elemento(driver, By.CLASS_NAME, "shopping_cart_link").click()
    producto_en_carrito = esperar_elemento(driver, By.CLASS_NAME, "inventory_item_name").text
